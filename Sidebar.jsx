    ...
    <aside className="w-64 flex-shrink-0 hidden md:flex flex-col border-r border-border bg-sidebar text-sidebar-foreground">
      <div className="p-4" ref={ref}>
        <button
          ...
          className="w-full flex items-center gap-2 px-2.5 py-2 rounded-lg hover:bg-sidebar-accent transition-all duration-200 hover:shadow-sm group"
        >
          <span className="w-7 h-7 rounded-md flex items-center justify-center text-white text-xs font-semibold shadow-sm group-hover:shadow-glow-sm transition-shadow" style={{ backgroundColor: currentProject?.color || '#7c3aed' }}>
                ...
                return (
                  <div key={p.id} className="flex items-center gap-2">
                    <button onClick={() => { setCurrentProject(p); setProjectMenu(false); }} className="flex-1 flex items-center gap-2 px-2 py-1.5 rounded-md hover:bg-accent text-sm transition-colors">
                      <span className="w-5 h-5 rounded flex items-center justify-center text-white shadow-sm" style={{ backgroundColor: p.color }}><I className="w-3 h-3" /></span>
